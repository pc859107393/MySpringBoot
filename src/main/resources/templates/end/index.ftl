                ...
                <div class="tpl-portlet">
                    ...
                    <div class="tpl-scrollable">
                        ...
                        <table class="am-table tpl-table">
                            ...
                            <tr>
                                <td>
                                    <img src="${base}/static/img/user01.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${base}/static/img/user02.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${base}/static/img/user03.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${base}/static/img/user04.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${base}/static/img/user05.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${base}/static/img/user06.png" alt="" class="user-pic">
